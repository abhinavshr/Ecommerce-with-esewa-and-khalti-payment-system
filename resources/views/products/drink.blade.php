...
<body>
    ...
    <div class="sidenav-container" style="display: flex;">
        ...
        <div class="right">
            ...
            <div class="sorting">
                <form action="{{ route('user.drink') }}" method="GET" style="float: right;">
            ...
            <div class="product-list">
                ...
                @foreach ($products->where('product_category', 'Drink') as $product)
                    <a href=" {{ route('user.product', ['id' => $product->id]) }} ">
                        <div class="product-card">
                            @if ($product->discounted_price > 0)
                                <div class="sale-tag">
                                    <p
                                        style="color: white; font-weight: bold; background-color: red; margin-top: 10px;">
                                        {{ $product->discounted_price }}% OFF</p>
                                </div>
                            @endif
                            <div class="product-image">
                                <img src="{{ asset('storage/images/products/' . $product->product_image) }}"
